#!/usr/bin/env python3
"""Contributor identity resolution: git commit email → GitHub login.

Byte-verbatim extraction from scripts/release.py (Part of #79962, #78647).
scripts/release.py re-exports every name defined here, so ``release.<name>``
and ``from release import <name>`` keep resolving to the identical objects.
"""
