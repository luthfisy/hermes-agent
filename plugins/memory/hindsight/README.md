...
| `llm_default_headers` | — | JSON object of HTTP headers sent with every embedded LLM request |
...
| `HINDSIGHT_LLM_DEFAULT_HEADERS` | JSON object of default headers for local-mode LLM requests |
