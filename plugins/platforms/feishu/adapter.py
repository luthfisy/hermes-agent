...
# --- Rich text / markdown rendering + inbound message normalization ---
# Extracted byte-verbatim to feishu_rendering.py (2K-law fracture, #79904).
# Re-exported here so ``plugins.platforms.feishu.adapter.<name>`` keeps resolving to the
# very same object for callers (and for any monkeypatch target keyed on the old path).
from plugins.platforms.feishu.feishu_rendering import (  # noqa: F401
    ...
    _is_style_enabled,
    _join_nested_posts,
    _load_feishu_payload,
    _normalize_feishu_text,
    _normalize_interactive_message,
    _normalize_merge_forward_message,
    _normalize_share_chat_message,
