...
# Shard of this module (#79911): rendering/sanitization lives in rendering.py and is
# re-exported here by identity, so ``adapter.<name>`` stays the same object.
from plugins.platforms.matrix.rendering import (  # noqa: F401
    _MatrixHtmlSanitizer, _TEX_DISPLAY_TOKEN, _TEX_INLINE_TOKEN, _TEX_TOKEN_RE,
    _latex_to_tokens, _pre_sanitize_matrix_markdown, _sanitize_matrix_html, _tokens_to_mx_maths)
