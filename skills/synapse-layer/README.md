...
Scope of this PR: documentation and manifest only — no runtime implementation is included in this PR. Implementation will be provided in a follow-up PR.
...
Add to `~/.hermes/.env` (use `skills/synapse-layer/.env.example` as a template):
```
