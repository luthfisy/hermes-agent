...
_MEMORY_ROUTING_BLOCK = (
    ...
    "Consent overrides both: if the user said not to save something — to either store, in this "
    "conversation or a past one you can see — never propose adding it, even if it would otherwise "
    "fit. Do not save it 'anyway' and do not summarize around the refusal to keep it recoverable.\n\n"
