...
OPENAI_MODEL_EXECUTION_GUIDANCE = (
    ...
    "- If the underlying source returns empty, partial, or suspiciously narrow results, retry with a broader or "
    "different query or strategy before concluding. A truncated display is different: first recover the needed "
    "fields from its saved output or already-loaded session data. Do not repeat successful calls just to recover "
    "omitted output. If the saved artifact is also partial, missing records remain unknown.\n"
