...
# Image-shrink recovery shard (Part of #79926): identity re-exports — `agent.conversation_compression.<name>`
# is the same object the shard defines, so `module.attr` callers and patch targets stay green.
from agent.image_shrink_recovery import (
