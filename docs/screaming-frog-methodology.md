...
5. **Canonical Chain**: cadenas de canónicas (A→B→C)
6. **Canonical Loop**: bucles de canónicas (A→B→A)
7. **No Canonical**: URLs sin ninguna etiqueta canónica

#### 5. Revisar hallazgos específicos

**Canonical Chain Detection:**
1. Filtrar por **Canonical Chain**
2. SF muestra la cadena completa en la columna **Canonical URL**
3. Ejemplo: `URL-A → URL-B → URL-C`

**Canonical Loop Detection:**
1. Filtrar por **Canonical Loop**
2. SF marca las URLs que forman un bucle infinito
3. Ejemplo: `URL-A → URL-B → URL-A`

**Canonical a External URL:**
1. Filtrar por **Canonicalised (to external URL)**
...
3. SF ofrece 3 tipos de visualización:
...
#### 3c. Sunburst Chart
- **Qué muestra:** Anillos concéntricos donde cada anillo representa un nivel de profundidad
- **Layout:** Centro = homepage, anillos sucesivos = niveles de profundidad
- **Útil para:** Distribución visual de URLs por profundidad, detectar desequilibrios
- **Configuración:**
  - **Start URL**: URL raíz
  - **Max Rings**: número de anillos
  - **Segment colours**: por tipo de contenido o status
...
Crawl Analysis > Visualisations > Sunburst Chart
