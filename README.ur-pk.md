...
آپ اپنی مرضی کا کوئی بھی ماڈل استعمال کر سکتے ہیں — [Nous Portal](https://portal.nousresearch.com)، OpenRouter، OpenAI، اپنا حسب ضرورت اینڈ پوائنٹ، اور [بہت سے دیگر](https://hermes-agent.nousresearch.com/docs/integrations/providers)۔ ماڈل تبدیل کرنے کے لیے `hermes model` استعمال کریں — کوڈ میں کوئی تبدیلی نہیں، کوئی پابندی نہیں۔
