...
# ───────────────────────────────────────────────────────────────────────
# Secret redaction for migration reports lives in the sibling module
# scripts/openclaw_to_hermes_redaction.py (#79938, 2K-law).  Imported here
# only for this module's own report writes — no re-export shim (AGENTS.md
# code-shape rules); tests import the defining module directly.
# ───────────────────────────────────────────────────────────────────────
sys.path.insert(0, str(Path(__file__).resolve().parent))

from openclaw_to_hermes_redaction import redact_migration_value  # noqa: E402
