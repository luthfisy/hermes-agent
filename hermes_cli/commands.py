...
COMMAND_REGISTRY: list[CommandDef] = [
    ...
    CommandDef("auth", "Manage inference accounts in private Telegram chat", "Configuration",
               gateway_only=True, busy_policy="dispatch", args_hint="[list|add|priority|cancel]"),
