...
COMMAND_REGISTRY: list[CommandDef] = [
    ...
    CommandDef("group", "List privately authorized groups or show list help", "Session",
               gateway_only=True, args_hint="list [page] | help", subcommands=("list", "help"),
               busy_policy="dispatch", desktop="messaging"),
