...
def build_webhook_parser(subparsers, *, cmd_webhook: Callable) -> None:
    ...
    wh_disable = webhook_subparsers.add_parser("disable", help="Disable a dynamic subscription without deleting it")
    wh_disable.add_argument("name", help="Subscription name to disable")
    wh_enable = webhook_subparsers.add_parser("enable", help="Re-enable a disabled dynamic subscription")
