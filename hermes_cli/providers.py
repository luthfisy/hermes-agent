...
HERMES_OVERLAYS: Dict[str, HermesOverlay] = {
    ...
    "stepfun-cn": HermesOverlay(extra_env_vars=("STEPFUN_CN_API_KEY",),
                                base_url_override="https://api.stepfun.com/v1",
                                base_url_env_var="STEPFUN_CN_BASE_URL"),
    ...
    "stepfun-plan-cn": HermesOverlay(extra_env_vars=("STEPFUN_CN_API_KEY",),
                                     base_url_override="https://api.stepfun.com/step_plan/v1",
                                     base_url_env_var="STEPFUN_CN_STEP_PLAN_BASE_URL"),
...
_ALIAS_GROUPS: Dict[str, Tuple[str, ...]] = {
    ...
    "stepfun": ("stepfun-ai",), "stepfun-cn": ("stepfun-china", "stepfun_cn"),
    "stepfun-plan": ("step", "stepfun-coding-plan", "stepfun-step-plan"),
    "stepfun-plan-cn": ("stepfun-step-plan-cn", "stepfun-coding-plan-cn"),
...
_LABEL_OVERRIDES: Dict[str, str] = {
    ...
    "copilot-acp": "GitHub Copilot ACP", "stepfun": "StepFun", "stepfun-cn": "StepFun (China)",
    "stepfun-plan": "StepFun Step Plan", "stepfun-plan-cn": "StepFun Step Plan (China)",
    "xiaomi": "Xiaomi MiMo", "gmi": "GMI Cloud",
