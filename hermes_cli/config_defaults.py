...
OPTIONAL_ENV_VARS = {
    ...
    "FASTMETAL_API_KEY": _prov("FastMetal API key (OpenAI-compatible gateway to 80+ models, prepaid JPY billing)",
        "FastMetal API Key", "https://fastmetal.ai/dashboard", advanced=False),
    "FASTMETAL_BASE_URL": _prov("FastMetal base URL override (default: https://api.fastmetal.ai/v1)",
        "FastMetal base URL (leave empty for default)", None, password=False),
