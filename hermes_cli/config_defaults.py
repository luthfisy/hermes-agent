...
# Optional env-var catalog (entry factories + OPTIONAL_ENV_VARS) lives in
# hermes_cli/config_defaults_env_vars.py; re-exported here for identity, so
# hermes_cli.config_defaults.<name> keeps resolving to the same objects.
from hermes_cli.config_defaults_env_vars import (  # noqa: E402,F401
    _OMIT,
    _base_url,
    _category,
    _env,
