...
_SPECS = [
    ...
    _cmd("edit", [
        ...
        _arg("--goal", action=argparse.BooleanOptionalAction, default=None, dest="goal_mode",
             help="Enable or disable goal mode before the task's first worker run"),
        ...
        _arg("--clear-goal-max-turns", action="store_true",
             help="Clear the pre-start goal-mode turn budget to use the engine default"),
