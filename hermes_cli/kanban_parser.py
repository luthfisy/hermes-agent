...
_SPECS = [
    ...
    _cmd("edit", [
        ...
        _arg("--goal", action="store_true", default=None, dest="goal_mode",
             help="Enable goal mode before the task's first worker run"),
        _arg("--no-goal", action="store_false", default=None, dest="goal_mode",
             help="Disable goal mode before the task's first worker run"),
        _arg("--goal-max-turns", type=int, metavar="N",
             help="Set the pre-start goal-mode turn budget"),
        _arg("--clear-goal-max-turns", action="store_true",
             help="Clear the pre-start goal-mode turn budget to use the default"),
