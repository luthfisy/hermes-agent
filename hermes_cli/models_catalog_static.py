...
_PROVIDER_MODELS: dict[str, list[str]] = {
    ...
    # step-router-v1 is served only by the China Step Plan endpoint (live /models, 2026-09).
    "stepfun": ["step-5-preview", "step-3.7-flash", "step-3.5-flash", "step-3.5-flash-2603"],
    "stepfun-cn": ["step-5-preview", "step-3.7-flash", "step-3.5-flash", "step-3.5-flash-2603"],
    "stepfun-plan": ["step-5-preview", "step-3.7-flash", "step-3.5-flash", "step-3.5-flash-2603"],
    "stepfun-plan-cn": ["step-5-preview", "step-3.7-flash", "step-3.5-flash", "step-3.5-flash-2603",
                        "step-router-v1"],
    "moonshot": [
...
CANONICAL_PROVIDERS: list[ProviderEntry] = [ProviderEntry(*row) for row in (
    ...
    ("stepfun", "StepFun", "StepFun standard chat completions (api.stepfun.ai)"),
    ("stepfun-cn", "StepFun (China)", "StepFun standard chat completions (api.stepfun.com)"),
    ("stepfun-plan", "StepFun Step Plan", "StepFun Step Plan (Agent / coding models, api.stepfun.ai)"),
    ("stepfun-plan-cn", "StepFun Step Plan (China)", "StepFun Step Plan (Agent / coding models, api.stepfun.com)"),
