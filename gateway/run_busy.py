    ...
    async def _busy_queue_command(self, event: MessageEvent, quick_key: str, source):
        ...
        if adapter:
            self._enqueue_fifo(quick_key, MessageEvent(
                ...
                reply_to_channel_id=event.reply_to_channel_id,
                reply_to_origin_channel_id=event.reply_to_origin_channel_id,
                reply_to_author_id=event.reply_to_author_id,
                reply_to_author_name=event.reply_to_author_name,
                reply_to_attachments=list(event.reply_to_attachments),
