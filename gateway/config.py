...
class GatewayConfig:
    ...
    # Values are SessionSource-shaped mappings validated at request time.
    ...
    _SCALAR_DICT_FIELDS = (
        ...
        "max_concurrent_sessions", "multiplex_profiles", "session_key_aliases",
    ...
    def from_dict(cls, data: Dict[str, Any]) -> "GatewayConfig":
        ...
        return cls(
            ...
            **{name: _coerce_bool(data.get(name), default) for name, default in _TOPLEVEL_BOOL_DEFAULTS.items()},
            ...
            session_key_aliases=(dict(pick("session_key_aliases"))
                                 if isinstance(pick("session_key_aliases"), dict) else {}),
