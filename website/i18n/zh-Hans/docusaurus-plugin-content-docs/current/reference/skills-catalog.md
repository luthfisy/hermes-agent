...
| [`social-har-api-connectivity`](/user-guide/skills/bundled/social-media/social-media-social-har-api-connectivity) | 捕获浏览器会话以驱动社交 API（仅限授权使用）。 | `social-media/social-har-api-connectivity` |
