---
title: "Acp Delegate — Delegate a prompt to another Hermes ACP session"
sidebar_label: "Acp Delegate"
...
Delegate a prompt to another Hermes ACP session.

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `hermes skills install official/communication/acp-delegate` |
| Path | `optional-skills/communication/acp-delegate` |
| Version | `0.1.0` |
