---
title: "Protean Github Draft — Use when a GitHub draft needs review before posting"
sidebar_label: "Protean Github Draft"
description: "Use when a GitHub draft needs review before posting"
---

{/* This page is auto-generated from the skill's SKILL.md by website/scripts/generate-skill-docs.py. Edit the source SKILL.md, not this page. */}

# Protean Github Draft

Use when a GitHub draft needs review before posting.

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `hermes skills install official/software-development/protean-github-draft` |
| Path | `optional-skills/software-development/protean-github-draft` |
| Version | `1.0.0` |
