---
title: "Macos Harness — Use when direct macOS or Chrome CDP control is required"
sidebar_label: "Macos Harness"
...
Use when direct macOS or Chrome CDP control is required.

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `hermes skills install official/autonomous-ai-agents/macos-harness` |
| Path | `optional-skills/autonomous-ai-agents/macos-harness` |
| Version | `1.0.0` |
