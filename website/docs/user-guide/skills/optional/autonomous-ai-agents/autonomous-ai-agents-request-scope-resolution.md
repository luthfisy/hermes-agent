---
title: "Request Scope Resolution — Resolve vague requests via JEV, memory, then user"
sidebar_label: "Request Scope Resolution"
...
Resolve vague requests via JEV, memory, then user.

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `hermes skills install official/autonomous-ai-agents/request-scope-resolution` |
| Path | `optional-skills/autonomous-ai-agents/request-scope-resolution` |
| Version | `0.1.0` |
