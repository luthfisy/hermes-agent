...
| `FASTMETAL_API_KEY` | FastMetal API key — OpenAI-compatible gateway to 80+ models, prepaid JPY billing ([fastmetal.ai/dashboard](https://fastmetal.ai/dashboard)) |
| `FASTMETAL_BASE_URL` | Override FastMetal base URL (default: `https://api.fastmetal.ai/v1`) |
