...
| `TOKEN_KIOSK_API_KEY` | Token Kiosk API key ([token-kiosk.gaib.ai](https://token-kiosk.gaib.ai)) |
| `TOKEN_KIOSK_BASE_URL` | Override Token Kiosk base URL (default: `https://api-token-kiosk.gaib.ai/v1`) |
