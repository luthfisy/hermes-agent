...
| [**macos-harness**](../user-guide/skills/optional/autonomous-ai-agents/autonomous-ai-agents-macos-harness.md) | Use when direct macOS or Chrome CDP control is required. |
