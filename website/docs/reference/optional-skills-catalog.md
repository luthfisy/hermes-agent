...
| [**request-scope-resolution**](/docs/user-guide/skills/optional/autonomous-ai-agents/autonomous-ai-agents-request-scope-resolution) | Resolve vague requests via JEV, memory, then user. |
