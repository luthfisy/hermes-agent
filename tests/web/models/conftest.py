...
# Playwright is an optional dev dependency — skip these UI tests entirely
# rather than failing collection for contributors who haven't installed it.
playwright_async_api = pytest.importorskip(
    "playwright.async_api",
    reason="playwright is required for the web UI tests",
)
