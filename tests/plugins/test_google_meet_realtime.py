...
def test_connect_sends_session_update_with_voice_and_instructions(monkeypatch):
    ...
    # Auth header is sufficient for the GA Realtime API.
...
def test_speak_sends_create_and_response_and_writes_audio(monkeypatch, tmp_path):
    ...
    recv_frames = [
        ...
        {"type": "response.output_audio_transcript.delta", "delta": base64.b64encode(b"caption text").decode()},
    ...
    assert resp["output_modalities"] == ["audio"]
