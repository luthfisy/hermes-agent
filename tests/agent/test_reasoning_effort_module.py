...
class TestCodexVocabulary:
    ...
    def test_per_model_max_support(self):
        """GPT-5.6 and GPT-6 Luna/Sol accept max; GPT-5.5 does not."""
        from agent.reasoning_effort import (
            CODEX_GPT56_EFFORTS,
        ...
        assert codex_supported_efforts("gpt-6-luna-900k") is CODEX_GPT56_EFFORTS
        assert codex_supported_efforts("gpt-6-terra") is CODEX_GPT56_EFFORTS
