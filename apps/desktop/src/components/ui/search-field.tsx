  ...
  return (
    ...
    >
      ...
      <input
        ...
        className={cn(
          // flex-1 consumes the row space before trailing controls, keeping
          // them at its edge; min-w-0 lets the input shrink in narrow contexts
          // so long queries scroll inside the field.
