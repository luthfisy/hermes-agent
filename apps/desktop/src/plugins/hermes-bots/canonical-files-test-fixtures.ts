/** Pure fixtures retained from #104199. */
import type { GroupFilesPage } from './group-files-parser'

export const FILE_BINDING = { connectionId: 'gateway-a', profile: 'reviewer', roomId: 'room-1' }
