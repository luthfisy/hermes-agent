...
const tr: BotsMessages = {
  roster: {
    search: 'Botlarda ve grup sohbetlerinde ara',
    searchPlaceholder: 'Botlarda ve grup sohbetlerinde ara…',
    ...
    allHiddenDesc: 'Çalışmaya ve geçmişlerini korumaya devam ederler.',
    showHidden: 'Gizli botları göster',
    noHiddenMatch: 'Bu filtrelerle eşleşen gizli bot yok.',
    hiddenFromRoster: 'Listeden gizlendi',
    pinned: 'Sabitlendi',
    ...
    rosterUnavailable: reason =>
      `Liste kullanılamıyor: ${reason}. Ağ geçidiniz profiles.list'ten eskiyse Hermes'i güncelleyip ağ geçidini yeniden başlatın.`,
    waitingForGateway:
      'Ağ geçidi bağlantısı bekleniyor… (uzak ağ geçitleri birkaç saniye sürebilir; otomatik yeniden dener)'
  },
  sections: {
    ...
    nameLabel: 'Bölüm adı',
    namePlaceholder: 'örn. Müşteriler',
    create: 'Oluştur',
    rename: 'Yeniden adlandır…',
    moveUp: 'Yukarı taşı',
    moveDown: 'Aşağı taşı',
    unassigned: 'Atanmamış',
    options: name => `${name} bölüm seçenekleri`,
    ...
    removeFromSection: 'Bölümden çıkar',
    deleted: (name, count) =>
      count === 0
        ? `“${name}” silindi`
        : `“${name}” silindi — ${count} bot Atanmamış'a taşındı`,
    undo: 'Geri al'
  },
  bot: {
    newTitle: 'Yeni bot',
    ...
    editMenu: 'Düzenle…',
    helpPromptPlaceholder: 'Bu bot ne konuda yardımcı olsun?',
    descriptionHint: 'Botun adından ve açıklamasından üretmek için boş bırakın.',
    newChatWith: 'Bu botla yeni sohbet',
    openBotChat: 'Bot Sohbetini Aç',
    pinToTop: 'Üste sabitle',
    unpin: 'Sabitlemeyi kaldır',
    pinnedToast: name => `${name} üste sabitlendi`,
    unpinnedToast: name => `${name} sabitlemesi kaldırıldı`,
    hide: 'Gizle',
    unhide: 'Göster',
    hiddenToast: name => `${name} gizlendi — gizli botları görmek için Botlar başlığındaki göz düğmesini kullanın`,
    unhiddenToast: name => `${name} tekrar listede`,
    groupsMenu: groups => `Gruplar: ${groups}…`,
    manageGroups: 'Grupları yönet…',
    metadataLoadFailed: 'Bot meta verileri yüklenemedi',
    loadFailed: 'Bot yüklenemedi',
    groupsLoadFailed: 'Bot grupları yüklenemedi',
    thisDevice: 'Bu cihaz',
    attentionFallback: 'İlgi gerekiyor',
    attentionProviderAuth: 'Bu profil için tekrar giriş yapın',
    attentionQuota: 'Kota veya bakiye tükendi',
    attentionMissingConfig: 'Sağlayıcı yapılandırılmadı — hermes model çalıştırın',
    attentionBlocked: 'Bot engellendi — son mesajına bakın',
    duplicate: 'Çoğalt',
    duplicateFailed: 'Çoğaltma başarısız',
    deleteTitle: 'Bot ve profil silinsin mi?',
    removeFromAllGroups: 'Tüm gruplardan çıkar',
    createFirstHint: 'Botlar bölmesini açıp “Yeni Bot”a basın.',
    createFailed: 'Profil henüz oluşturulamadı',
    advanced: 'Gelişmiş',
    advancedHint: 'Gelişmiş — model, beceriler, araç setleri, SOUL.md',
    advancedFailed: 'Gelişmiş yapılandırma başarısız',
    openAnotherChatUnsupported: "Başka bir Bot sohbeti açmak için Hermes Desktop'ı güncelleyin.",
    remoteConnectionsUnsupported: "Diğer bağlantılardaki botlarla sohbet etmek için Hermes Desktop'ı güncelleyin.",
    openNeedsUpdateTitle: "Bu bot daha eski bir Hermes'te çalışıyor",
    openNeedsUpdateMessage: connectionLabel => `${connectionLabel} güncelleyin, sonra tekrar deneyin.`,
    openUnreachableTitle: 'Hermes bu botun çalıştığı bilgisayara ulaşamadı',
    openUnreachableMessage: 'Çevrimiçi olduğundan emin olup tekrar deneyin.',
    openChatFailedTitle: botName => `${botName} botunun sohbeti açılamadı`,
    openChatFailedMessage: 'Tekrar deneyin.',
    openGateways: 'Ağ Geçitlerini Aç',
    chatEmpty: 'Başlamak için bir şeyler söyleyin.',
    kickoff: 'Selam, kendinden bahset!'
  },
  avatar: {
    classicShapes: 'Klasik şekiller',
    blobFromName: 'Blob yüz — botun adından çizilir',
    unlockFollowsName: 'Kilidi aç — yüz yeniden botun adını izler',
    randomize: 'Rastgele yap',
    tabBot: 'Bot',
    tabGenerate: 'Üret',
    upload: 'Yükle',
    tabPet: 'Evcil hayvan',
    removeImage: 'Görseli kaldır — şekil kullan',
    removeBackToShape: 'Kaldır — şekil avatarına dön',
    describePlaceholder: 'Avatarınızı tarif edin…',
    describeHint: 'Ad/başlık/açıklama + agent-messaging listesinden otomatik üretmek için boş bırakın.',
    matchTheName: 'Adla eşleştir',
    pickPet: "Bu botun profil resmi olarak bir evcil hayvan seçin.",
    petLoadFailed: 'O evcil hayvan yüklenemedi — başka birini deneyin.',
    imageTooLarge: 'Görsel çok büyük (en fazla 15MB).',
    generationFailed: 'Avatar üretimi başarısız',
    savedLocally: 'Görünüm yerel olarak kaydedildi; uzak kalıcılık başarısız',
    savedLocallyDescriptionFailed: 'Görünüm yerel olarak kaydedildi; açıklama güncellemesi başarısız',
    generate: 'Üret',
    generating: 'Üretiliyor…'
  },
  group: {
    newTitle: 'Yeni grup sohbeti',
    manageDesc: 'Bir bot birden çok grup sohbetine katılabilir. Üyelikler her makineye eşitlenir.',
    manageTitle: 'Grupları yönet',
    settingsTitle: 'Grup ayarları',
    settingsDesc: 'Grubu yeniden adlandırın veya bir oda resmi ayarlayın. Üyeler ve geçmiş korunur.',
    nameLabel: 'Grup adı',
    ...
    deleteAction: 'Sil',
    composerPlaceholder: 'Bir şeyler söyleyin — bu gruptaki her bot odayı duyar.',
    slashCommandsUnsupported:
      'Grup sohbetlerinde eğik çizgi komutları desteklenmez. Kullanmak için bir bireysel bot sohbeti açın.',
    attachHint: 'Dosya ekle — yanıtlayan her bot görür',
    newThread: 'Yeni Konu',
    reply: 'Yanıtla',
    replyInThread: 'Konuda yanıtla',
    replyInThreadPlaceholder: 'Konuda yanıtla…',
    openThread: 'Bu konuyu aç',
    collapseThread: 'Konuyu daralt',
    collapseThreadLabel: 'Bu konuyu daralt',
    activity: 'Etkinlik',
    noActivityYet: 'Bu turda henüz etkinlik yok.',
    showActivity: 'Oda etkinliğini göster',
    hideActivity: 'Oda etkinliğini gizle',
    stop: 'Durdur',
    stopHint: 'Bu çalıştırmayı durdur — sıradaki üyeyi keser ve gerisini bekletir',
    allHeldStatus: count => `${count} botun tümü duraklatıldı`,
    heldMembersStatus: members => `Duraklatıldı: ${members}`,
    holdReleaseHint: 'Serbest bırakmak için duraklatılmış bir botu etiketleyin veya @all resume gönderin.',
    needsYourInput: 'Bu grup sohbetindeki bir bot girişinizi bekliyor',
    noMembersToSend: group =>
      `${group} grubunda gönderilecek üye yok — bir bot ekleyin ya da üyeler hâlâ yükleniyorsa odayı yeniden açın.`,
    pictureGenerationFailed: 'Grup resmi üretimi başarısız',
    nameTaken: name => `“${name}” adında bir grup zaten var.`,
    memberCount: count => `${count} bot`,
    you: 'Siz',
    availableCount: (available, total) => `${total} üyeden ${available} kullanılabilir`,
    settingsHint: group => `Grup ayarları — ${group} grubunu yeniden adlandırın veya oda resmi ayarlayın`,
    ...
    disbandDescPrefix: 'Bu, ',
    disbandDescSuffix: count =>
      ` gruplamasını ${count} botundan kaldırır ve paylaşılan oda kaydını temizler. Botların kendisi ve grup başına oturumları korunur.`,
    stopped: group => `${group} durduruldu — kalan turlar siz sürdürene kadar bekletilir`,
    removeAttachment: 'Eki kaldır',
    threadFallback: 'Konu',
    replyCount: replies => `${replies} yanıt`,
    dropToThread: 'Bu konu yanıtına eklemek için bırakın',
    dropToRoom: 'Eklemek için bırakın — yanıtlayan her bot görür',
    waitingForAnswer: 'Yanıtınız bekleniyor…',
    memberThinking: name => `${name} düşünüyor…`,
    roomWorking: 'Oda çalışıyor…',
    messageRoom: group => `${group} grubuna mesaj`,
    newThreadPlaceholder: group => `${group} içinde yeni konu… (yönlendirmek için @ad, herkes için @everyone)`,
    everyoneMeta: 'Odadaki her bot',
    commandApproval: 'komut onayı',
    answerFailed: (handle, error) => `@${handle} adresine yanıt gönderilemedi: ${error}`,
    wantsToRunCommand: handle => `@${handle} bir komut çalıştırmak istiyor:`,
    asks: handle => `@${handle} soruyor:`,
    answerTo: member => `@${member} yanıtla`
  },
  tools: {
    skillsHub: "Hermes Beceri Hub'ı",
    filterSkills: 'Becerileri filtrele…',
    searchHub: "Hub'da ara (topluluk + bilinen kaynaklar)…",
    noMcpServers: 'Yapılandırılmış veya katalogda MCP sunucusu yok.'
  },
  cron: {
    filterHint:
      'Bu profilde zamanlanmış işler var ama hiçbiri bu bot için etiketlenmemiş. Burada göstermek için bir işi "[bot:<ad>] …" olarak adlandırın veya aşağıdaki Cron\'da görün.',
    needsRosterFirst: 'Bu botun önce listede görünmesi gerekir.',
    staleNotice: 'Zamanlanmış işler yenilenemedi. Elimizdeki son liste gösteriliyor.',
    readFailure: 'Liste hâlâ orada olabilir — bu bir okuma hatasıydı, silme değil.',
    createDesc: bot => `${bot} botunun bir zamanlamayla çalıştırdığı tekrarlayan görev. Çalıştırmalar kendi sohbet geçmişine düşer.`,
    instruction: 'Talimat',
    whenToRun: 'Ne zaman çalışsın',
    dayOfMonth: 'Ayın günü',
    sendResultsTo: 'Sonuçları şuraya gönder',
    runHistoryOnly: 'Yalnızca çalıştırma geçmişi',
    botChatTarget: bot => `${bot} botunun sohbeti (bot yanıt verir)`,
    continuity:
      'Süreklilik: her çalıştırma bir önceki çalıştırmanın çıktısını görür (yinelenenleri ayıkla, kaldığı yerden devam et)',
    onceIn: when => `Bir kez (${when})`,
    everyNDays: days => `Her ${days} günde`,
    everyNHours: hours => `Her ${hours} saatte`,
    everyNMinutes: minutes => `Her ${minutes} dakikada`,
    freqOnce: 'Bir kez, şu zamanda…',
    freqHourly: 'Her saat',
    freqDaily: 'Her gün',
    ...
    unitHours: 'saat',
    unitDays: 'gün',
    runsOnce: (count, unit) => `Bir kez çalışır, şimdiden ${count} ${unit} sonra`,
    runsHourly: 'Her saat başı çalışır',
    runsDaily: time => `Her gün ${time} saatinde çalışır`,
    runsWeekdays: time => `Pazartesi–Cuma ${time} saatinde çalışır`,
    runsWeekly: (day, time) => `Her ${day} ${time} saatinde çalışır`,
