...
export const ar = defineLocale({
  ...
  settings: {
    ...
    about: {
      ...
      unattendedTitle: 'تحديث ليلي',
      unattendedDesc: 'في إصدار ويندوز لسطح المكتب، حدّث Hermes تلقائيًا إلى أحدث إصدار في وقت محلي تختاره. معطّل افتراضيًا.',
      unattendedEnabled: 'تفعيل التحديث التلقائي المجدول',
      unattendedHourLabel: 'الساعة',
