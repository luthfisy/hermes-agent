...
export const ar = defineLocale({
  ...
  settings: {
    ...
    telemetry: {
      ...
      intro:
        'يمكن لـ Hermes جمع مقاييس استخدام مجهولة على هذا الجهاز ومشاركتها مع Nous Research للمساعدة في تحسين الوكيل. تكون معطّلة ما لم تقم بتفعيلها.',
      pointCounters:
        'عدّادات ومدرّجات تكرارية محدودة فقط: استدعاءات النموذج، استخدام الأدوات، الأخطاء، فئات زمن الاستجابة.',
      pointNoContent:
        'لا تتضمن أبدًا المطالبات أو الردود أو محتويات الملفات أو أسماء الملفات أو أي شيء يُكتب في المحادثة.',
      pointInstallId:
        'تحمل الحزم معرّف تثبيت عشوائيًا لكل ملف تعريف لتجميع الأيام. لا يحتوي على معلومات شخصية ويُعاد ضبطه عند حذف مجلد القياس.',
      pointConsentWindow:
        'تُرسَل الحزمة اليومية فقط إذا وقعت فترة جمعها كاملةً ضمن وقت كانت فيه المشاركة مفعّلة. تبقى بيانات ما قبل الاشتراك أو أي فجوة على هذا الجهاز.',
      docsLink: 'اقرأ وصف البيانات الكامل',
      sharingTitle: 'المشاركة',
      shareLabel: 'مشاركة مقاييس الاستخدام المجهولة مع Nous Research',
      shareDesc: 'يجمع المقاييس محليًا ويرسل حزمة يومية إلى Nous. إيقافه يوقف الإرسال فورًا.',
      collectOnlyNote:
        'يجمع هذا الملف التعريفي المقاييس محليًا لكنه لا يرسلها (ضُبط من سطر الأوامر). تفعيل المشاركة سيبدأ الإرسال؛ وإيقافها سيوقف الجمع أيضًا.',
      inheritedNote:
        'لا يملك هذا الملف التعريفي إعدادًا خاصًا به ويتبع الإجابة التي قدمتها عند سؤالك أول مرة. تبديل المفتاح يضبطه لهذا الملف التعريفي فقط.',
      deploymentNote:
        'لا يملك هذا الملف التعريفي إعدادًا خاصًا به ويتبع الإعداد الافتراضي الذي حدده هذا النشر. تبديل المفتاح يضبطه لهذا الملف التعريفي فقط.',
      cliHint: 'الإعداد نفسه متاح من الطرفية عبر `hermes setup telemetry`.',
      enabledTitle: 'مشاركة القياس مفعّلة',
      enabledMessage: 'تُجمع المقاييس محليًا وتُرسَل إلى Nous Research يوميًا.',
      disabledTitle: 'مشاركة القياس معطّلة',
      disabledMessage: 'لا يُجمع أو يُرسل شيء. تُركت الملفات المحلية الموجودة في مكانها.',
      failedSave: 'تعذّر حفظ إعداد القياس',
      filesTitle: 'الملفات المحلية',
      filesLabel: 'مجلد القياس',
      filesDesc:
        'كل ما يجمعه Hermes موجود هنا: قاعدة بيانات المقاييس، والحزم اليومية المنتظرة في صندوق الصادر، وسجل أوقات تفعيل المشاركة. احذف المجلد لإعادة ضبط معرّف التثبيت.',
      filesRemoteDesc: 'يعمل هذا الملف التعريفي على بوابة بعيدة؛ ومجلد القياس الخاص به على ذلك الجهاز.',
      openFolder: 'فتح المجلد',
      openFolderFailed: 'تعذّر فتح مجلد القياس',
      promptTitle: 'مشاركة مقاييس الاستخدام المجهولة؟',
      promptDescription:
        'يمكن لـ Hermes إرسال عدّادات استخدام محدودة إلى Nous Research (استدعاءات النموذج، استخدام الأدوات، الأخطاء) — لا تتضمن أبدًا المطالبات أو الملفات أو البيانات الشخصية. يمكنك تغيير ذلك في أي وقت من الإعدادات ← القياس عن بُعد.',
      promptAccept: 'مشاركة',
      promptDecline: 'عدم المشاركة'
    },
    notifications: {
      title: 'الإشعارات',
      intro:
  ...
  onboarding: {
    ...
    change: 'تغيير',
    startChatting: 'ابدأ',
    shareMetricsLabel: 'مشاركة مقاييس الاستخدام المجهولة مع Nous Research',
