...
export const de = defineLocale({
  sendDiagnostics: {
    ...
    doneDescription:
      'Dein Bundle wurde privat hochgeladen. Teile den Link unten in deinem Support-Thread, damit das Team deine Logs sehen kann.',
    failedTitle: 'Upload fehlgeschlagen',
    failedHint:
      'Du kannst auch `hermes debug share --nous` in einem Terminal ausführen oder `hermes debug share --local`, um den Bericht auszugeben, ohne ihn hochzuladen.',
  ...
  boot: {
    ...
    errors: {
      ...
      gatewayConnectionLostDetail:
        'Im Hintergrund wird weiter versucht. Du kannst weiterlesen und Entwürfe schreiben. Öffne die Gateway-Einstellungen, falls das anhält.'
    },
    failure: {
      cloudDownTitle: 'Nous-Cloud-Agent ist offline',
      cloudDownDescription:
        'Der von Nous verwaltete Cloud-Agent, mit dem sich dieses Gateway verbindet, liefert einen Serverfehler. Von hier aus lässt er sich nicht neu starten — prüfe seinen Status, wechsle zum lokalen Gateway oder hol dir Support.',
      cloudDownHint:
        'Die Buttons unten öffnen das Nous Portal (Instanz-Status und Steuerung) und unseren Discord für Support.',
  ...
  notifications: {
    ...
    errors: {
      ...
      codeSkewRestartRequired:
        'Dieses Backend läuft nach einem Update noch mit altem Code. Starte es neu, damit der neue Code geladen wird.'
    },
    voice: {
  ...
  settings: {
    ...
    appearance: {
      ...
      translucencyDesc:
        'Sieh deinen Desktop durch das gesamte Fenster, samt Text. Separat abgestimmt für Hell und Dunkel.',
      product: 'Produkt',
      ...
      resumeLastSessionDesc:
        'Wenn aktiv, öffnet die App beim Kaltstart deinen letzten Chat wieder. Deaktiviere es, um immer mit einem neuen Chat zu starten.',
      translucencyFrost: {
        'under-window': 'Tief',
        popover: 'Sanft',
        titlebar: 'Hell',
      ...
      tipsDesc:
        'Eine kleine Blase, die auf einen Teil der App zeigt. Sie erscheint gelegentlich in Ruhephasen und dann, wenn Hermes meint, sie hilft. Wer eine schließt, ist sie dauerhaft los.',
      ...
      vibeHeartsDesc:
        'Aufsteigende Herzen, wenn du dich bedankst, ily oder good bot schreibst oder ein Herz schickst. Unabhängig von den Nachrichten-Reaktionen darüber.'
    },
    ...
    fieldDescriptions: defineFieldCopy({
      ...
      tts: {
        xai: {
          ...
          autoSpeechTags:
            'Ein LLM fügt vor der Synthese ausdrucksstarke Audio-Tags ([laughing], [sighs]) in den Text ein.',
    ...
    localModels: {
      ...
      installDetail:
        'Lädt die llama.cpp-Inferenz-Engine herunter (einige hundert MB). Modelle, die du herunterlädst, laufen vollständig auf diesem Rechner — kein Konto, nichts verlässt deinen Computer.',
      installAction: 'Laufzeit installieren',
      installing: 'Installiere Laufzeit…',
      installFailed: 'Installation der Laufzeit fehlgeschlagen',
      hardwareTitle: 'Dieser Rechner',
      hardwareLoading: 'Prüfe deine Hardware…',
      vram: label => `${label} GPU-Speicher`,
      ram: label => `${label} RAM`,
      unifiedMemory: 'Gemeinsamer Speicher',
      modelsTitle: 'Modelle',
      recommended: 'Empfohlen',
      recommendedReason: {
        'best-quality-resident':
          'Das hochwertigste Modell, das vollständig auf deiner GPU mit voller Geschwindigkeit läuft. Die Auswahl wägt Qualität gegen die erwartete Geschwindigkeit auf dieser Hardware ab.',
        'speed-gated-quality':
          'Ein hochwertigeres Modell würde auf diesen Rechner passen, aber bei dieser Speicherbandbreite zu langsam antworten — dies ist das beste Modell, das schnell bleibt.',
        'fastest-resident':
          'Kein Modell erreicht auf dieser Hardware volle Geschwindigkeit; dieses kommt am nächsten heran und läuft dabei vollständig im GPU-Speicher.',
        'least-painful-spilled':
          'Kein Modell passt hier vollständig in den GPU-Speicher — dieses läuft aus dem Arbeitsspeicher am besten.'
      ...
      updateDetail: (next, current) =>
        `Ein neuerer llama.cpp-Build (${next}) ist bereit zur Installation — du nutzt ${current}. Modelle funktionieren während des Downloads weiter.`,
      updateAction: 'Engine aktualisieren',
      updating: 'Aktualisiere Engine…',
      upToDateTitle: 'Engine ist aktuell',
      upToDateDetail: (tag, backend) =>
        `Läuft mit llama.cpp ${tag} (${backend}) — der neueste Build, den Hermes ausliefert.`,
      updateToast: next =>
        `Ein neuerer Build der lokalen Engine (${next}) ist verfügbar. Aktualisiere unter Einstellungen → Lokale Modelle.`,
      activeDetail: 'Neue Chats nutzen dieses Modell — es wird geladen, sobald du deine erste Nachricht sendest',
      activeNotLoaded: 'Wird bei deiner ersten Nachricht geladen',
      loadedPill: 'Im Speicher',
      placementResident: 'komplett auf der GPU',
      ...
      placementSpilledTip:
        'Ein Teil dieses Modells läuft aus dem Arbeitsspeicher — es funktioniert, aber langsamer. Ein kompakterer Build oder ein kleinerer Kontext würde vollständig passen.',
      loadingPill: 'Lade…',
      ...
      pillUsesRam: 'Nutzt Arbeitsspeicher',
      pillTooBig: 'Zu groß für diesen Rechner',
      browseTitle: 'Weitere Modelle finden',
      browseHint:
        'Durchsuche ganz Hugging Face. Modelle, die du hier herunterlädst, werden automatisch an deinen Rechner angepasst, sind aber nicht von uns getestet.',
      ...
      browseFitUnknown: 'Passung unbekannt',
      ...
      sideloadTitle: 'GGUF-Modelldatei auswählen',
    ...
    about: {
      ...
      bundleSwapPending: 'Neu starten, um das Update abzuschließen',
    ...
    toolsets: {
      ...
      browserRealProfile: {
        ...
        description:
          'Kopiert Anmeldungen und Cookies deines Standardbrowsers in eine verwaltete Kopie, mit der der Agent surft. Dein laufendes Profil wird nie direkt geöffnet. Gilt für neue Sitzungen.',
    ...
    plugins: {
      ...
      agentHalfMissing: 'Agent-Teil fehlt hier',
      agentHalfMissingTip:
        'Das ist der Desktop-Teil eines mitgelieferten Plugins, aber sein Agent-Teil ist auf dem aktuell verbundenen Backend/Profil nicht installiert. Installiere ihn unter Fähigkeiten → Plugins.',
      installModal: {
    ...
    vault: {
      title: 'Passwörter & Anmeldungen',
      blurb:
        'Sag „log dich bei GitHub ein“ und der Agent meldet dich an. Beim ersten Login fragt er dich direkt auf der Seite nach den Zugangsdaten; danach funktioniert es von allein. Passwörter werden auf diesem Gerät verschlüsselt und direkt in die Seite eingefügt — das Modell sieht sie nie.',
      count: n => `${n} gespeichert`,
      loadFailed: 'Tresor-Einträge konnten nicht geladen werden',
      empty: 'Noch nichts gespeichert',
      emptyDesc:
        'Du musst hier nichts anlegen. Bitte den Agent, dich an einem Dienst anzumelden, und er fragt dich einmal direkt nach dem Login. Falls du lieber vorab etwas eintragen willst, nimm „Hinzufügen“.',
      add: 'Hinzufügen',
      addTitle: 'Anmeldung, Karte oder Adresse hinzufügen',
      addDescription: 'Verschlüsselt auf diesem Gerät gespeichert. Der Agent sieht das Passwort nie.',
      added: 'Gespeichert.',
      adding: 'Speichern…',
      addConfirm: 'Speichern',
      kindField: 'Art',
      kinds: { login: 'Anmeldung', payment: 'Zahlungskarte', address: 'Adresse' },
      labelField: 'Bezeichnung',
      labelPlaceholder: 'z. B. GitHub-Arbeitskonto',
      labelRequired: 'Eine Bezeichnung ist erforderlich.',
      originField: 'Origin der Website',
      originPlaceholder: 'https://github.com',
      originPlaceholderCheckout: 'https://shop.example.com',
      originInvalid: 'Gib eine gültige URL ein, z. B. https://example.com.',
      ...
      countryField: 'Land',
      optional: '(optional)',
      createdOn: date => `Hinzugefügt ${date}`,
      ...
      otpHint: 'Der „Einrichtungsschlüssel“, den die Website bei der 2FA-Aktivierung anzeigt. Ist er gespeichert, erzeugt Hermes die Codes selbst.',
      ...
      sources: {
        ...
        blurb:
          'Installierte Passwort-Manager werden automatisch erkannt. Beim ersten Zugriff bittet der Agent dich, einen zu entsperren (einmal pro Sitzung); nur ein Sitzungs-Token bleibt im Speicher, und der Agent sieht weder dein Master-Passwort noch einen Login.',
        toggleFailed: 'Passwort-Manager konnte nicht aktualisiert werden',
        notInstalled: name =>
          `Nicht erkannt. Installiere das Kommandozeilen-Tool ${name} und melde dich darin an; Hermes übernimmt es automatisch.`,
        disabledDesc: 'Erkannt, aber für Hermes deaktiviert.',
        lockedDesc: 'Erkannt. Der Agent fragt dich beim Zugriff, das Tool zu entsperren — oder entsperre jetzt.',
        unlockedDesc: 'Für diese Sitzung entsperrt. Sperrt nach 30 Minuten Inaktivität automatisch oder wenn Hermes geschlossen wird.',
        ...
        unlockDescription:
          'Gib dein Master-Passwort ein. Es wird dem Passwort-Manager auf diesem Gerät übergeben und sofort verworfen — es wird nie gespeichert, protokolliert oder dem Agenten gezeigt.',
    ...
    managedUpdates: {
      ...
      intro:
        'Aktualisiert die vom Desktop verwalteten SSH-Installationen in einem Zug: Sitzungen laufen aus, der entfernte Checkout wird aktualisiert, und jedes Profil wird mit einem zugehörigen Beleg wiederhergestellt.',
      sshConnection: 'Vom Desktop verwaltete SSH-Installation',
      progress:
        'Sitzungen laufen aus, die entfernte Installation wird aktualisiert und Profile werden wiederhergestellt …',
  ...
  profiles: {
    remoteOverride: {
      ...
      description:
        'Sitzungen in diesem Profil laufen auf dem Remote-Hermes, auf den du sie zeigen lässt, statt auf diesem Rechner.',
      ...
      plainTextOptIn:
        'Dieser Rechner hat keinen sicheren Schlüsselspeicher, das Token würde also unverschlüsselt auf der Festplatte liegen. Trotzdem speichern.',
      collisionWarning: label =>
        `Ein Gateway namens „${label}“ existiert bereits in den Einstellungen. Diese Profil-Verbindung ist davon getrennt und ändert daran nichts.`,
      confirmTitle: 'Dieses Profil mit einem Remote-Host verbinden?',
      confirmNote: (profile, host) =>
        `Neue Chats in ${profile} laufen auf ${host}. Dieser Rechner führt dort Befehle aus und liest dort Dateien, nicht auf diesem hier. Verbinde dich nur mit einem Host, dem du vertraust.`,
      confirmBack: 'Zurück',
      connect: 'Verbinden',
      connecting: 'Verbinde…',
      ...
      authFailedMessage: (profile, host) =>
        `${host} hat das für ${profile} gespeicherte Token abgelehnt. Möglicherweise wurde es auf der Remote-Seite geändert.`,
  ...
  onboarding: {
    ...
    signInExpired:
      'Anmeldung ist beim Warten auf die Autorisierung abgelaufen. Meist ist die Anmeldeseite im geöffneten Tab hängen geblieben (serverseitiges Problem) — schließe die Anmeldung dort ab und versuche es dann erneut. Schlägt es weiterhin fehl, nutze stattdessen einen API-Schlüssel oder den CLI-Fallback.',
  ...
  shell: {
    ...
    statusbar: {
      ...
      systemResources: {
        ...
        ram: 'RAM',
        unifiedNote: 'Gemeinsamer Speicher — GPU und System teilen sich diesen Pool.',
      ...
      cacheHitRateTitle:
        'Prompt-Cache-Trefferquote dieser Sitzung — gecachte Tokens kosten weniger, höher ist also günstiger',
      tokensPerSecondTitle: 'Ausgabe-Tokens pro Sekunde, gemittelt über die letzten 10 Modellaufrufe',
      webhooks: 'Webhooks',
  ...
  desktop: {
    ...
    readOnlyTranscriptBody:
      'Noch kein verbundenes Backend beansprucht diesen älteren Chat, deshalb wurde er als schreibgeschütztes Protokoll geöffnet. Der Verlauf ist vollständig. Senden ist gesperrt, bis ein Backend ihn übernimmt.',
  ...
  tips: {
    ...
    items: {
      ...
      'local-setup': {
        ...
        text: 'Deine Hardware kann ein lokales Modell betreiben. Chats bleiben auf deinem Computer und kosten nichts.',
        action: 'Einrichten'
      },
      'right-pane': {
