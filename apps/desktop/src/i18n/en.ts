...
export const en: Translations = {
  ...
  skills: {
    ...
    marketplace: {
      ...
      description: 'Choose a reviewed blueprint, then inspect and install a fresh bot profile on the selected gateway.',
      iframeTitle: 'Bot Marketplace',
      reviewTitle: 'Review Bot',
      reviewDescription: 'The selected backend is loading the authoritative blueprint.',
      loading: 'Loading bot details…',
      catalogFailed: 'Could not load the Bot Marketplace catalog.',
      retry: 'Retry',
      catalogUnavailable: 'No longer available in the live catalog',
      pollTimedOut: 'The sample is still running. Use “Finish setup” to check again.',
      remoteModelUnsupported: 'Model setup for a bot on another connection is not available from this window. Open that gateway directly to change its model.',
      notFound: catalog => `“${catalog}” is not available from this backend.`,
      creator: creator => `Created by ${creator}`,
      freshCopy: 'This creates a fresh profile. Future catalog changes do not alter your installed bot.',
      destination: profile => `Source profile: ${profile}. The new bot is created beside it on the same gateway.`,
      nameLabel: 'Bot name',
      nameInvalid: 'Use 1–64 lowercase letters, numbers, hyphens, or underscores.',
      credentialsLabel: 'Credentials',
      credentialsNone: 'Start without copied API keys',
      credentialsCopy: 'Copy API keys from the source profile',
      capabilities: 'Included skills and tools',
      contract: 'SOUL and operating contract',
      starterPrompt: 'Starter prompt',
      none: 'None',
      add: 'Add Bot',
      adding: 'Adding…',
      notCommitted: 'The backend did not commit this bot. Nothing was added.',
      installFailed: 'Could not add this bot.',
      setupRequired: 'The bot was added, but its required accounts must be connected before the first chat.',
      added: name => `${name} was added`,
      chatStarted: 'Its Bot Chat is ready.',
      chatWarning: reason => `The bot was committed, but its Bot Chat could not be opened: ${reason}`,
      browse: 'Browse Bot Marketplace…',
      nativeCatalog: 'Native catalog',
      siteCatalog: 'Marketplace website',
      search: 'Search bots',
      installed: 'Installed bots',
      noInstalled: 'No Marketplace bots are installed on this gateway yet.',
      addAnother: 'Add another',
      finishSetup: 'Finish setup',
      open: 'Open',
      setupFailed: 'Could not refresh bot setup',
      routineFailed: 'Could not update routine',
      readiness: {
        ready: 'Ready',
        needsSetup: 'Needs setup',
        runtime: 'Model and runtime',
        firstTask: 'First task',
        firstTaskComplete: 'Completed in the canonical Bot Chat.',
        firstTaskPending: 'Run the reviewed starter once setup is complete.',
        finishSetup: 'Finish setup',
        checkAgain: 'Check again',
        rechecking: 'Checking…',
        startFirstTask: 'Run sample task',
        open: 'Open Bot Chat',
        reusedSignIn: 'Reusing the existing sign-in for this profile.',
        setupAction: (kind, id) => `Set up ${id || kind}`,
        samples: 'Starter example',
        samplesHint: 'The installed workflow also carries its reviewed samples and references.'
      },
      routines: {
        title: 'Routines',
        locked: 'Complete setup and the first task before activating routines.',
        schedule: 'Schedule',
        timezone: 'Timezone',
