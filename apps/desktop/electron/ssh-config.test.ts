...
// Include resolution joins POSIX-style virtual paths with the host path API;
// on Windows OpenSSH itself resolves includes with Windows path semantics, so
// these pin the POSIX layout only.
