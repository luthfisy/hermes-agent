...
export const af: Translations = {
  ...
  kanban: {
    ...
    skills: "Vaardighede",
    goalMode: "Doelmodus",
    goalModeDescription: "Die werker gaan voort totdat 'n beoordelaar saamstem dat die taak klaar is.",
    goalTurnBudget: "Doelbeurtbegroting",
    goalTurnBudgetDescription: "Maksimum werkerbeurte. Laat leeg om die enjin se verstek te gebruik.",
    goalTurnBudgetDefault: "Enjinverstek",
    goalTurnBudgetValidation: "Voer 'n positiewe heelgetal in.",
    goalConfigurationLocked: "Doelinstellings is gesluit omdat hierdie taak reeds uitgevoer is.",
