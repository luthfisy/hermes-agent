...
export const ru: Translations = {
  ...
  kanban: {
    ...
    skills: "Навыки",
    goalMode: "Режим цели",
    goalModeDescription: "Исполнитель продолжает работу, пока проверяющий не подтвердит завершение задачи.",
    goalTurnBudget: "Лимит ходов цели",
    goalTurnBudgetDescription: "Максимальное число ходов исполнителя. Оставьте поле пустым, чтобы использовать значение движка по умолчанию.",
    goalTurnBudgetDefault: "По умолчанию движка",
    goalTurnBudgetValidation: "Введите положительное целое число.",
    goalConfigurationLocked: "Настройки цели заблокированы, потому что эта задача уже запускалась.",
    createdBy: "Создал",
    result: "Результат",
