...
export const tr: Translations = {
  ...
  kanban: {
    ...
    skills: "Beceriler",
    goalMode: "Hedef modu",
    goalModeDescription: "Bir değerlendirici görevin tamamlandığını onaylayana kadar çalışan devam eder.",
    goalTurnBudget: "Hedef tur sınırı",
    goalTurnBudgetDescription: "En fazla çalışan turu. Motorun varsayılanını kullanmak için boş bırakın.",
    goalTurnBudgetDefault: "Motor varsayılanı",
    goalTurnBudgetValidation: "Pozitif bir tam sayı girin.",
    goalConfigurationLocked: "Bu görev daha önce çalıştırıldığı için hedef ayarları kilitli.",
    createdBy: "Oluşturan",
    result: "Result",
    comments: "Yorumlar",
    events: "Olaylar",
