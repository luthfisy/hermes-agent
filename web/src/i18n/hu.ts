...
export const hu: Translations = {
  ...
  kanban: {
    ...
    skills: "Készségek",
    goalMode: "Célmód",
    goalModeDescription: "A dolgozó addig folytatja, amíg egy bíráló késznek nem ítéli a feladatot.",
    goalTurnBudget: "Célfordulók kerete",
    goalTurnBudgetDescription: "A dolgozó fordulóinak maximális száma. Hagyd üresen a motor alapértékéhez.",
    goalTurnBudgetDefault: "Motor alapértéke",
    goalTurnBudgetValidation: "Adj meg pozitív egész számot.",
    goalConfigurationLocked: "A célbeállítások zárolva vannak, mert ez a feladat már futott.",
