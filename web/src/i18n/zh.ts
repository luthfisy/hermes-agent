...
export const zh: Translations = {
  ...
  kanban: {
    ...
    skills: "技能",
    goalMode: "目标模式",
    goalModeDescription: "工作者会持续运行，直到评审确认任务已完成。",
    goalTurnBudget: "目标轮次上限",
    goalTurnBudgetDescription: "工作者的最大轮次数。留空则使用引擎默认值。",
    goalTurnBudgetDefault: "引擎默认值",
    goalTurnBudgetValidation: "请输入正整数。",
    goalConfigurationLocked: "此任务已运行过，因此目标设置已锁定。",
    createdBy: "创建者",
    result: "结果",
    comments: "评论",
    events: "事件",
