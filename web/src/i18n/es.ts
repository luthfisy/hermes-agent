...
export const es: Translations = {
  ...
  kanban: {
    ...
    goalModeDescription: "El trabajador continúa hasta que un revisor confirma que la tarea está terminada.",
    goalTurnBudget: "Límite de turnos del objetivo",
    goalTurnBudgetDescription: "Máximo de turnos del trabajador. Déjalo vacío para usar el valor predeterminado del motor.",
    goalTurnBudgetDefault: "Predeterminado del motor",
    goalTurnBudgetValidation: "Introduce un número entero positivo.",
    goalConfigurationLocked: "La configuración del objetivo está bloqueada porque esta tarea ya se ha ejecutado.",
