...
export const ar = defineLocale({
  ...
  kanban: {
    ...
    skills: "المهارات",
    goalMode: "وضع الهدف",
    goalModeDescription: "يستمر العامل حتى يوافق المراجع على اكتمال المهمة.",
    goalTurnBudget: "حد جولات الهدف",
    goalTurnBudgetDescription: "الحد الأقصى لجولات العامل. اتركه فارغًا لاستخدام الإعداد الافتراضي للمحرك.",
    goalTurnBudgetDefault: "إعداد المحرك الافتراضي",
    goalTurnBudgetValidation: "أدخل عددًا صحيحًا موجبًا.",
    goalConfigurationLocked: "إعدادات الهدف مقفلة لأن هذه المهمة سبق تشغيلها.",
