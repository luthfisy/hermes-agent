...
export const ja: Translations = {
  ...
  kanban: {
    ...
    skills: "スキル",
    goalMode: "ゴールモード",
    goalModeDescription: "判定者がタスクの完了に同意するまで、ワーカーが処理を続けます。",
    goalTurnBudget: "ゴールのターン上限",
    goalTurnBudgetDescription: "ワーカーの最大ターン数です。空欄の場合はエンジンの既定値を使用します。",
    goalTurnBudgetDefault: "エンジンの既定値",
    goalTurnBudgetValidation: "正の整数を入力してください。",
    goalConfigurationLocked: "このタスクはすでに実行されているため、ゴール設定はロックされています。",
    createdBy: "作成者",
    result: "結果",
    comments: "コメント",
    events: "イベント",
