...
export const zhHant: Translations = {
  ...
  kanban: {
    ...
    skills: "技能",
    goalMode: "目標模式",
    goalModeDescription: "工作者會持續執行，直到審查者確認任務已完成。",
    goalTurnBudget: "目標回合上限",
    goalTurnBudgetDescription: "工作者的最大回合數。留空則使用引擎預設值。",
    goalTurnBudgetDefault: "引擎預設值",
    goalTurnBudgetValidation: "請輸入正整數。",
    goalConfigurationLocked: "此任務已執行過，因此目標設定已鎖定。",
    createdBy: "建立者",
    result: "結果",
    comments: "留言",
    events: "事件",
