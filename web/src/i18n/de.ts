...
export const de: Translations = {
  ...
  kanban: {
    ...
    skills: "Fähigkeiten",
    goalMode: "Zielmodus",
    goalModeDescription: "Der Worker läuft weiter, bis ein Prüfer die Aufgabe als erledigt bestätigt.",
    goalTurnBudget: "Ziel-Rundenlimit",
    goalTurnBudgetDescription: "Maximale Worker-Runden. Leer lassen, um den Standard der Engine zu verwenden.",
    goalTurnBudgetDefault: "Engine-Standard",
    goalTurnBudgetValidation: "Gib eine positive ganze Zahl ein.",
    goalConfigurationLocked: "Die Zieleinstellungen sind gesperrt, da diese Aufgabe bereits ausgeführt wurde.",
