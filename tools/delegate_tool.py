...
from tools.delegate_tool_registry import (  # noqa: F401
    ...
    _handle_control_action, _is_descendant_of, _owns_subagent_record, _record_matches_live_owner,
    _register_subagent, _unregister_subagent,
    get_subagent_attribution, interrupt_subagent, is_spawn_paused, list_active_subagents,
    owned_subagent_status, set_spawn_paused, steer_subagent,
)
