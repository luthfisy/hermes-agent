...
from tools.delegate_tool_registry import (  # noqa: F401
    ...
    _dead_subagent_hits, _dead_subagent_hits_lock, _non_retryable_subagent_error, _record_dead_subagent_hit,
    _reset_dead_subagent_hits, _stale_subagent_error, _DEAD_SUBAGENT_HITS_CAP, _STALE_SUBAGENT_RETRY_LIMIT,
